...
export function getRuntimeReadiness() {
  ...
  const employeeViewSessionConfigured = serverEnv.EMPLOYEE_VIEW_SESSION_SECRET
  ...
  if (!employeeViewSessionConfigured) {
    warnings.push('EMPLOYEE_VIEW_SESSION_SECRET is not configured; kiosk self-view remains insecure or unavailable.')
  }
