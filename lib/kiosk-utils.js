...
export function getSafeDecisionMessage(decisionCode) {
  switch (decisionCode) {
    ...
    case 'challenge_required':
      return { name: 'Additional check', detail: 'One more live motion check is required for this scan.' }
    case 'blocked_active_challenge':
      return { name: 'Motion check failed', detail: 'Complete the requested head movement and try again.' }
