...
export const DISTANCE_THRESHOLD_KIOSK = 0.85;       // Kiosk verification - lenient to avoid false rejects (L2 on unit vectors, max ~1.41)
export const DISTANCE_THRESHOLD_ENROLLMENT = 0.50;  // Enrollment duplicate check - stricter for accuracy
export const DISTANCE_THRESHOLD = 0.70;             // Default/fallback
...
export const AMBIGUOUS_MATCH_MARGIN = 0.08;        // Very lenient for kiosk to reduce false rejects
