...
export const MODEL_URL = EXPLICIT_MODEL_URL || LOCAL_MODEL_PATH
...
// --- Location ---
// Mobile GPS commonly needs 15-30 seconds for its first high-accuracy fix.
export const LOCATION_BOOT_TIMEOUT_MS = 30000
export const LOCATION_REFRESH_INTERVAL_MS = 60000
export const LOCATION_CACHE_MAX_AGE_MS = 30000
export const LOCATION_TARGET_ACCURACY_METERS = 50
export const LOCATION_MAX_ACCURACY_METERS = 250
