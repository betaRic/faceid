...
export const MODEL_URL = 'https://cdn.jsdelivr.net/npm/@vladmandic/human@3.3.6/models'
...
export const DUPLICATE_FACE_THRESHOLD = 0.50;
export const AMBIGUOUS_MATCH_MARGIN = 0.12;
