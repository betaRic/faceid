...
export async function upsertPersonSample(persons, profile, descriptors) {
  ...
  const captureMetadataError = validateEnrollmentCaptureMetadata(
    ...
    firebaseEnabled ? normalizedSampleFrames : normalizedDescriptors,
  )
  ...
  if (firebaseEnabled && sampleFrameValidationError) throw new Error(sampleFrameValidationError)
  if (!firebaseEnabled && descriptorValidationError) throw new Error(descriptorValidationError)
