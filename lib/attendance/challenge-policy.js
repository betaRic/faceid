...
export function resolveChallengeMode(riskFlags = []) {
  // Active motion challenge is intentionally disabled.
  // We keep the passive tokenized submission path and rely on Human's
  // built-in liveness, antispoof, eye/blink variance, and mesh movement.
  void riskFlags
  return 'passive'
}
