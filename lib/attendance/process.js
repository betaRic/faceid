...
export async function processAttendanceSubmission({ db, request, body, consumedChallenge = null }) {
  ...
  if (claimedEmployeeIdError) {
    const decisionCode = entry.employeeId ? 'blocked_invalid_employee_id' : 'blocked_missing_employee_id'
    entry.riskFlags = mergeRiskFlags(entry.riskFlags, ['invalid_claimed_employee_id'])
