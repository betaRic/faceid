...
async function tryGetCachedCandidates(officeIds) {
  ...
  // If ANY office has a cache miss, return null to force a full database fetch.
...
export async function syncPersonBiometricIndex(db, personId, personData) {
  ...
  // fetches fresh data from the local database. Without this, a newly enrolled person
