...
export const OVAL_MIN_FACE_AREA_RATIO = 0.35
export const OVAL_MAX_FACE_AREA_RATIO = 0.85

export const PERFECT_FACE_AREA_RATIO_MIN = 0.52
export const PERFECT_FACE_AREA_RATIO_MAX = 0.72
