...
export const CAPTURE_FACE_AREA_HINT_MIN = 0.08
export const CAPTURE_FACE_AREA_READY_MIN = 0.12
export const CAPTURE_FACE_AREA_TARGET_RATIO = 0.18
export const CAPTURE_FACE_AREA_READY_MAX = 0.38
export const CAPTURE_FACE_AREA_TOO_CLOSE = 0.56
