...
// The previous band still tolerated captures that were effectively too far on mobile.
// This revision moves the "good" zone closer while keeping enough slack for different
// phone/laptop camera FOVs and for the full head to remain inside the oval.
export const CAPTURE_FACE_AREA_HINT_MIN = 0.12
export const CAPTURE_FACE_AREA_READY_MIN = 0.18
export const CAPTURE_FACE_AREA_TARGET_RATIO = 0.28
export const CAPTURE_FACE_AREA_READY_MAX = 0.44
export const CAPTURE_FACE_AREA_TOO_CLOSE = 0.62
